...
Page({
    ...
    pay: function() {
        var t = this.data.goods, s = t.money * t.num;
    ...
    confirm: function() {
        ...
        s.get("creditshop/detail/pay", {
            ...
            o.error > 0 ? e.toast(t, o.message) : (t.setData({
                logid: o.logid
            }), o.wechat && o.wechat.success && s.pay(o.wechat.payinfo, function(s) {
                "requestPayment:ok" == s.errMsg && t.lottery();
            }), "credit" == a && o.logid > 0 && t.lottery(), "" == a && o.logid > 0 && t.lottery());
        });
    },
    success: function() {
