...
Page({
    ...
    sycleconfirm: function() {
        var t = this, a = t.data.cycelid, r = t.data.checkedDate / 1e3, s = t.data.orderid, c = t.data.isdelay;
    ...
    editdate: function(t) {
        var a = this, i = t.currentTarget.dataset.isdelay, s = t.currentTarget.dataset.id;
    ...
    confirm_receipt: function(t) {
        var a = this, r = t.currentTarget.dataset.id, s = a.data.orderid;
