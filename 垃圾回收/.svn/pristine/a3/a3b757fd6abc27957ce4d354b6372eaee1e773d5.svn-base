...
Page({
    ...
    onLoad: function(t) {
        ...
        o.setData({
            ...
            e += " " + t.style.logostyle, o.setData({
                ...
                arrCart: a,
                style: e
            }), s = 1 == o.data.main.cartdata ? o.data.pageid : "", o.data.main.advs) {
    ...
    addGoodToCartFn: function(t) {
        ...
        a.setData({
            ...
            addtype: "delete"
        }), "1" == t.currentTarget.dataset.more && "reduce" == a.data.addtype ? n.toast(a, "请在购物车中修改多规格商品") : "reduce" == a.data.addtype && t.currentTarget.dataset.min == t.currentTarget.dataset.num ? n.toast(a, "不能少于" + t.currentTarget.dataset.min + "件商品") : "1" != t.currentTarget.dataset.more && "0" == t.currentTarget.dataset.diyformtype && t.currentTarget.dataset.canadd || ("reduce" != a.data.addtype && "delete" != a.data.addtype ? (a.setData({
            showPicker: !0,
            cycledate: !1
