...
module.exports = {
    number: function(t, e) {
        ...
        s.max, 1 == d && 1 == s.value && "minus" == t.target.dataset.action || d < i && "minus" == t.target.dataset.action ? o.toast(e, "单次最少购买" + s.value + "件") : s.value == s.max && "plus" == t.target.dataset.action || (parseInt(e.data.stock) < parseInt(d) ? o.toast(e, "库存不足") : e.setData({
            total: d
        }));
    },
    ...
    selectpicker: function(e, s, d, i) {
        ...
        "" == r && s.setData({
            ...
            if (t.goods.presellstartstatus || void 0 == t.goods.presellstartstatus || "1" != t.goods.ispresell) if (t.goods.presellendstatus || void 0 == t.goods.presellstartstatus || "1" != t.goods.ispresell) {
                ...
                }), r = 0 != t.goods.minbuy && s.data.total < t.goods.minbuy ? t.goods.minbuy : s.data.total; else if (s.setData({
                    pickerOption: t,
                    goods: t.goods,
                    options: a,
                    minpicker: d
