...
Page({
    ...
    onLoad: function(e) {
        ...
        this.setData({
            options: e
        }), console.log(e), a.getCache("isIpx") ? i.setData({
            isIpx: !0,
            ...
            console.log(a.data.stores), i.setData({
                data: a.data,
                sysset: a.sysset
    ...
    onShow: function() {
        ...
        a.getCache("orderShop"), t && this.setData({
            "data.address": t,
            aid: t.id
        });
    },
    toggle: function(a) {
        var e = t.pdata(a), i = e.id, d = {};
        d[e.type] = 0 == i || void 0 === i ? 1 : 0, this.setData(d);
    },
    onHide: function() {},
    onUnload: function() {},
    ...
    dataChange: function(a) {
        ...
        a.target.id, t.deduct = a.detail.value;
