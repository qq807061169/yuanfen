...
Page((a = {
    ...
    t(e, "goods_hint_show", !1), t(e, "presellisstart", 0), t(e, "advHeight", 1), e),
    ...
    comentTap: function(t) {
        ...
        o = "bad") : 5 == a && (e.data.commentPage = 1, o = "pic"), a != e.data.commentObjTab && s.get("goods/get_comment_list", {
            id: e.data.options.id,
            level: o,
            page: e.data.commentPage
        }, function(t) {
    ...
    getDetail: function(t) {
        ...
        e.setData({
            ...
            t.goods.thumbMaxHeight;
            if (t.goods.thumbMaxWidth, e.setData({
                coupon: o,
                coupon_l: o.length,
            ...
            n = setInterval(function() {
                ...
                discountTitle: "活动已结束"
            }), t.goods.istime > 0 && (clearInterval(e.data.timer), n = setInterval(function() {
            ...
            var r = e.data.fullbackgoods;
            if (void 0 != r) {
                console.log(r);
                var c = r.maxfullbackratio, g = r.maxallfullbackallratio, c = Math.round(c), g = Math.round(g);
                e.setData({
                    maxfullbackratio: c,
                    maxallfullbackallratio: g
                });
            }
    ...
    selectPicker: function(t) {
        o.checkAuth();
        var e = this, a = t.currentTarget.dataset.time, s = t.currentTarget.dataset.timeout;
        if (e.data.limits) {
            if (console.log(s), "timeout" == a || "access_time" == a) {
